...
export default function SavedEssays() {
    ...
    return (
      <div className="max-w-4xl mx-auto p-4 lg:p-8">
        <header className="mb-6 lg:mb-10">
          <h1 className="text-2xl lg:text-4xl font-bold tracking-tight text-stone-900 mb-2">Saved Essays</h1>
          <p className="text-stone-500 text-base lg:text-lg">Your graded essays history.</p>
        </header>
        <div className="bg-white p-8 lg:p-12 rounded-2xl lg:rounded-3xl shadow-sm border border-stone-200 text-center">
          <FileText className="w-12 h-12 lg:w-16 lg:h-16 text-stone-300 mx-auto mb-4" />
          <h3 className="text-lg lg:text-xl font-bold text-stone-900 mb-2">No saved essays yet</h3>
          <p className="text-stone-500 text-sm lg:text-base">Grade an essay and save it to see your history here.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 lg:p-8">
      <header className="mb-6 lg:mb-10">
        <h1 className="text-2xl lg:text-4xl font-bold tracking-tight text-stone-900 mb-2">Saved Essays</h1>
        <p className="text-stone-500 text-base lg:text-lg">Review your past essays and feedback.</p>
      </header>
          ...
          <div key={item.id} className="bg-white rounded-2xl lg:rounded-3xl shadow-sm border border-stone-200 overflow-hidden">
            ...
            >
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-2 lg:gap-3 mb-1 lg:mb-2">
                  <span className="inline-flex items-center justify-center px-2 lg:px-3 py-0.5 lg:py-1 rounded-full bg-indigo-100 text-indigo-700 text-[10px] lg:text-sm font-bold">
            ...
            {expandedId === item.id && (
              <div className="p-4 lg:p-6 border-t border-stone-100 bg-stone-50/30 space-y-6 lg:space-y-8">
                {/* Original Essay */}
                <div>
                  <h4 className="text-[10px] lg:text-sm font-bold tracking-wider text-stone-400 uppercase mb-2 lg:mb-3">Original Essay</h4>
