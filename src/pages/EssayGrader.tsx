...
import { Loader2, CheckCircle2, AlertCircle, BookOpen, PenTool, LayoutList, Quote, Sparkles, Save } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      <header className="mb-10">
        <h1 className="text-4xl font-bold tracking-tight text-stone-900 mb-2">Essay Grader</h1>
        <p className="text-stone-500 text-lg">Get strict, official-style grading and 4.0+ level revisions.</p>
      </header>
      ...
      <div className="space-y-12">
        ...
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-stone-200">
          <form onSubmit={handleGrade} className="space-y-6">
            <div>
              <label htmlFor="prompt" className="block text-sm font-bold tracking-wider text-stone-400 uppercase mb-3">
                Essay Prompt
              </label>
              <textarea
                id="prompt"
            ...
            <div>
              <label htmlFor="essay" className="block text-sm font-bold tracking-wider text-stone-400 uppercase mb-3">
                Your Essay
              </label>
              <textarea
                id="essay"
          ...
          <div className="space-y-12">
            {loading ? (
              ...
              <div className="animate-in fade-in slide-in-from-bottom-8 duration-500 space-y-12">
                {/* Score Card */}
                <div className="bg-white rounded-3xl shadow-sm border border-stone-200 p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                  <div>
                    <h2 className="text-sm font-bold tracking-wider text-stone-400 uppercase mb-2">Estimated Score</h2>
                    <p className="text-stone-500">Based on official GRE criteria</p>
                  </div>
                  <div className="flex items-center gap-8">
                    <div className="text-7xl font-bold text-indigo-600 tracking-tighter">
                      {feedback.score?.toFixed(1) || '0.0'}
                      <span className="text-3xl text-stone-300 ml-1">/6.0</span>
                    </div>
                    <button
                      onClick={handleSave}
                      disabled={saved}
                ...
                <div className="space-y-6">
                  <h3 className="text-2xl font-bold text-stone-900 flex items-center gap-3 pb-2">
                  ...
                  <div className="space-y-8">
                    {(feedback.sentenceReviews || []).map((review, idx) => (
                      <div key={idx} className="bg-white rounded-3xl shadow-sm border border-stone-200 overflow-hidden">
                        {/* Original */}
                        <div className="p-6 border-b border-stone-100 bg-stone-50/50">
                          <div className="flex gap-4">
                            <Quote className="w-5 h-5 text-stone-400 flex-shrink-0 mt-1" />
                            <p className="text-stone-800 text-lg leading-relaxed">{review.original}</p>
                          </div>
                        </div>
                        ...
                        <div className="p-6 border-b border-stone-100">
                          <div className="flex gap-4">
                            ...
                            <div>
                              <h4 className="text-xs font-bold tracking-wider text-stone-400 uppercase mb-2">Critique</h4>
                        ...
                        <div className="p-6 bg-indigo-50/30">
                          <div className="flex gap-4">
                            ...
                            <div>
                              <h4 className="text-xs font-bold tracking-wider text-indigo-400 uppercase mb-2">Revised Version</h4>
                ...
                <div className="bg-white rounded-3xl shadow-sm border border-stone-200 p-8">
                  <h3 className="text-2xl font-bold text-stone-900 flex items-center gap-3 border-b border-stone-100 pb-4 mb-6">
